...
- [ ] **CLI-TEMPLATE-01**: 用户可以保存当前配置为模板（环境模板、项目模板、设备模板、全流程模板）
- [ ] **CLI-TEMPLATE-02**: 用户可以列出所有已保存的配置模板
- [ ] **CLI-TEMPLATE-03**: 用户可以从已保存的模板快速初始化环境
- [ ] **CLI-TEMPLATE-04**: 用户可以删除不需要的配置模板

### CLI-CONFIG (CLI 配置管理)

- [ ] **CLI-CONFIG-01**: 用户可以将配置导出为 JSON 文件
- [ ] **CLI-CONFIG-02**: 用户可以从 JSON 配置文件导入配置
